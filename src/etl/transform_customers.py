...
df = df.withColumn("customer_type", col("customer_type").cast("string"))
df = df.withColumn("id_type", col("id_type").cast("string"))
df = df.withColumn("id_number", col("id_number").cast("string"))
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": "s3://your-bucket/processed/customers/",
